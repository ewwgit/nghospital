...
$this->title = 'Nursing homes Report Count';
   ...
   ?>
    <table class="table table-striped table-bordered" border=0>
   	<tr >
   		...
   		<th style="width:40%;padding-left:25px" >Nursing Home Name</th>
		<th style="width:40%;padding-left:25px">Count</th>
   	</tr>
   	<tr>
   	<?php 
   	for($i=0;$i<count($nurcountary);$i++)
   	{
   		?>
   			<td style="width:40%;padding-left:25px"><?php echo $i+1;?></td>
   			<td style="width:40%;padding-left:25px"><?php echo $nurname[$i];?></td>
